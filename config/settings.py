...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "(django-insecure-z-7q@!7ibh6qek)053$m^=uv(ej=bevut^ou+2ue#_1)69k_g-",
)
...
STATIC_ROOT = os.path.join(BASE_DIR, "img", "static")
...
ACCOUNT_LOGOUT_ON_GET = True  # 로그아웃 버튼 클릭 시 자동 로그아웃A
